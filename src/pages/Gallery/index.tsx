  ...
  return (
    <>
      <div className="bg-lime-700 flex flex-col font-inter sm:gap-10 md:gap-10 gap-[898px] items-center justify-between mx-auto w-auto sm:w-full md:w-full">
        ...
        <div className="md:h-[896px] h-[898px] md:px-5 relative w-full">
          <div className="bg-blue_gray-100 h-[193px] mx-auto w-[44%]"></div>
          <div className="absolute flex flex-col h-full inset-[0] items-center justify-between m-auto md:px-10 sm:px-5 px-[200px] py-10 w-full">
            <div className="bg-deep_orange-200 flex flex-col items-center justify-start p-[21px] sm:px-5">
              <Text
